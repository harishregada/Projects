...
int pin,bal,choice; //moto e conder
...
*/ /*
    ...
    if(conn)
    {
         ...
         if(!qstate)
         {
             ...
             while(row=mysql_fetch_row(res))
             {
                 ...
                 //system("cls");
                 //cout<<"help[index] = "<<help[index]<<endl;
                 //system("pause");
    ...
    cout<<"HELP[0] : "<<help[0]<<endl;
    cout<<"HELP[1] : "<<help[1]<<endl;
    ...
    strcpy(PIN_help,PIN);
    strcpy(BALANCE_help,BALANCE);

    cout<<endl<<"Pin_Help : "<<PIN_help<<endl;
    cout<<"BALANCE_Help : "<<BALANCE_help<<endl;
